...
export default function SendMessage() {
  return (
    <div className="w-full bg-white md:px-20 px-6 py-6">
      <div className="w-full bg-[#f4f4f4] p-6 md:p-20 md:flex justify-between items-start gap-10
       md:gap-20 rounded-xl border-b-2 border-r-2 border-[#ff014f] hover:border-t-2 hover:border-l-2
        hover:border-b-0 hover:border-r-0  duration-700 hover:scale-105  transition-all">
        {/* Left Content */}
